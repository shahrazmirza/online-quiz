...
import questionsData from "../data/C#Questions copy.json";
...
function CSharp() {
  ...
  const generateQuiz = () => {
    // Retrieve previous attempts from sessionStorage
    let attempted = sessionStorage.getItem("csharpAttemptedQuestions");
